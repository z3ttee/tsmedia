    ...
    <div class="container">
        <div class="sidebar-categories">
            <ul>
                ...
                <router-link :to="{name: 'panelUsers'}" custom v-slot="{navigate, isActive, isExactActive}" v-if="$store.getters.hasPermission('permission.users')">
                    <li @click="navigate" :class="{'pressable-xl': true, 'active': isActive || isExactActive}"><img src="@/assets/images/icons/team.svg" alt=""></li>
                </router-link>
                <router-link :to="{name: 'panelGroups'}" custom v-slot="{navigate, isActive, isExactActive}" v-if="$store.getters.hasPermission('permission.groups')">
                    <li @click="navigate" :class="{'pressable-xl': true, 'active': isActive || isExactActive}"><img src="@/assets/images/icons/lock.svg" alt=""></li>
                </router-link>
            </ul>
        </div>
